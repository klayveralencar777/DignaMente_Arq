...
import { SessionRoom } from "./pages/Psychologist/SessionRoom";
...
import { TriageRoom } from './pages/Psychologist/TriageRoom';
import { PsychologistDashboard } from './pages/Psychologist/PsychologistDashboard';
import { WeeklyAvailability } from './pages/Psychologist/WeeklyAvailability';
import { PatientChart } from './pages/Psychologist/PatientChart';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* --- Rotas do Psicólogo --- */}
        <Route path="/psicologo/agenda" element={<WeeklyAvailability />} />
        ...
        {/* --- Rota Fallback (Sempre por último) --- */}
